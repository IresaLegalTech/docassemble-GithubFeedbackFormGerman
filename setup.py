...
setup(name='docassemble.GithubFeedbackFormGerman',
      version='0.2.4',
      ...
      install_requires=['docassemble.ALToolbox>=0.11.0'],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/GithubFeedbackFormGerman/', package='docassemble.GithubFeedbackFormGerman'),
     )
